...
<head>
    <meta charset="utf-8">
    <title>Contact Us - Credit Card</title>
                ...
                <div class="col-lg-8 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                    <form method="post" action="{{ route('lead-store') }}">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Leave a message here" name="description" id="description" style="height: 100px"></textarea>
                                    <label for="description">Description</label>
                                </div>
                            </div>
                            <div class="col-4 ms-auto">
                                <button class="btn btn-primary w-100 py-3 text-right" type="submit">Submit</button>
                            </div>
                        </div>
                    </form>
                </div>
